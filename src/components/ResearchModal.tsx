...
import { ResearchDetail } from '../data/researchDetails';
...
export const ResearchModal: React.FC<ResearchModalProps> = ({ isOpen, onClose, researchID }) => {
  const [details, setDetails] = React.useState<ResearchDetail | null>(null);
